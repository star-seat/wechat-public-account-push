export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx31f1b3b3f9bacf07",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "e30bd426c26b2026277cbe429b135278",
   ...
   */
  USERS: [oUHDa50F8Tk8ompplwupwaT6NlOg],
    {
      // 想要发送的人的名字
      name: "潘潘",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "oUHDa50F8Tk8ompplwupwaT6NlOg",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "jJGJs4StxcZXr1fJdVYT0RZMY9Yazdby3sq8gPiprWI",
      // 所在省份
      province: "江苏",
      // 所在城市
      city: "苏州",
